...
<AuthButton
trigger={<Button variant="ghost" className="text-white hover:text-blue-400 hover:bg-blue-400/10">Login</Button>}
dashboardTrigger={
<Button variant="ghost" className="text-white hover:text-blue-400 hover:bg-blue-400/10" asChild>
<Link to="/dashboard">Dashboard</Link>
</Button>
}
/>
<AuthButton
trigger={<Button className="bg-blue-500 hover:bg-blue-600 text-white">Get Started</Button>}
dashboardTrigger={
...
<AuthButton
trigger={<Button size="lg" className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 text-lg">Create Your Auction</Button>}
dashboardTrigger={
<Button size="lg" className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 text-lg" asChild>
